...
import ComponentUsage from '@components/homework-specific/ComponentUsage';
    ...
    const cards = [
        {
            ...
            action: () =>
                alert(
                    'Project was migrated to Typescript. Check the code implementation for specific details.'
                ),
        },
        {
            ...
            action: () => setSelectedComponent('LIST_COMPONENT'),
        },
        {
            ...
            action: () => setSelectedComponent('FORM_GENERATOR'),
        },
        {
            ...
            action: () => setSelectedComponent('PAGE_GENERATOR'),
        },
    ];
    ...
    return (
        <QueryClientProvider client={queryClient}>
            <div>
                ...
                >
                    ...
                    >
                        ...
                        <p className={clsx('text-gray80', 'text-2xl')}>
                            Don&#39;t hesitate to connect if you have any
                            questions.
                        </p>
                        <a
                            className={clsx(
                ...
                >
                    <ComponentUsage component={selectedComponent} />
                </section>
            </div>
        </QueryClientProvider>
    );
